...
function Profile() {
  ...
  async function getUser() {
    const user = await axios.get(`${baseUrl}userDetails/${decoded.user_id}/`)
    setUser(user.data)
  }
  ...
  const UserUpdate = async (e) => {
    ...
    try {
      const response = await axios.patch(`${baseUrl}userDetails/${decoded.user_id}/`, formData, {
        headers: {
                        ...
                        <div className="modal-content">
                          <Form onSubmit={UserUpdate} encType="multipart/form-data">
                            ...
                            <div className="modal-body">
                              ...
                              <Form.Group className="py-2">
                                <Form.Control type="password" name="password" placeholder="Password"defaultValue={user.password} />
                              </Form.Group>
                            </div>
